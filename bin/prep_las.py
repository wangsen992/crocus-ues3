...
if __name__ == "__main__":
    ...
    print("[debug] load influece region")
    ...
    print("[debug] Subset raw las into target area")
    ...
    print("[debug] Clear las to save memory")
    del las

    # Transformation to target crs
    print("[debug] Transformation to target crs")
    ...
    new_file.write(f"{args.target_dir}/subset_las_transformed.las")
