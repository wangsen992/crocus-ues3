...
#include "surfaceInterpolatedFixedProfileFvPatchField.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class Type>
Foam::surfaceInterpolatedFixedProfileFvPatchField<Type>::surfaceInterpolatedFixedProfileFvPatchField
(
    const fvPatch& p,
...
Foam::surfaceInterpolatedFixedProfileFvPatchField<Type>::surfaceInterpolatedFixedProfileFvPatchField
(
    const surfaceInterpolatedFixedProfileFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
template<class Type>
void Foam::surfaceInterpolatedFixedProfileFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void Foam::surfaceInterpolatedFixedProfileFvPatchField<Type>::write(Ostream& os) const
{
